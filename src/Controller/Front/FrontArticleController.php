...
class FrontArticleController extends AbstractController
{
    ...
    public function articleList(ArticleRepository $ArticleRepository)
    {
        ...
        return $this->render('Front/frontArticleList.html.twig' , [
            'articles'=>$articles ]);
    }
    ...
    public function articleShow($id , ArticleRepository $ArticleRepository)
    {
        ...
        return $this->render('Front/frontArticleShow.html.twig' ,['article'=>$article]);
    }
    ...
    public function search(ArticleRepository $articleRepository , Request $request)
    {
        ...
        return $this->render('Front/frontArticleSearch.html.twig' , [
            'articles' => $articles,
            'term' => $term
        ]);
